...
wget -O Data/lab_week8.zip https://www.dropbox.com/s/ieer9l0tzsj6f9z/data_week7.zip?dl=0
unzip -o -d Data/ Data/lab_week8.zip 
mv Data/data_week7/*.*  Data/ 
rm -r Data/data_week7/
```
